/* ripdraw.h Version 1.0T 8/1/14  Ripdraw header for Ripdraw C library, tutorial
 *
 * Function prototye and data type definition for Ripdraw C library
 * This header file should be included in user code that makes any core ripdraw library calls. 
 * 
